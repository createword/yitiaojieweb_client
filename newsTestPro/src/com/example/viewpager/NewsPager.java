...
public class NewsPager extends BasePager {
	...
	private String urlsuffix = "/zhbj/categories.json";
	...
	public void initData() {
		view = LayoutInflater.from(mActivity).inflate(R.layout.newspager, null);
		String cache = CacheUtils.getCache(IpUtils.MainIpServer + urlsuffix,
				mActivity);
	...
	public void getDataForServer() {
		...
		httpUtils.send(HttpMethod.GET, IpUtils.MainIpServer + urlsuffix,
				new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						asyJson(result);
						CacheUtils.setCache(IpUtils.MainIpServer + urlsuffix,
								result, mActivity);
					}
